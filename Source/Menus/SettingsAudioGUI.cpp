...
void SettingsAudioGUI::UpdateMasterVolumeControls() {
	...
	m_MasterVolumeLabel->SetText("全局音量 : " + std::to_string(masterVolume)); //Volume
...
void SettingsAudioGUI::UpdateMusicVolumeControls() {
	...
	m_MusicVolumeLabel->SetText("BGM音量: " + std::to_string(musicVolume)); //Volume
...
void SettingsAudioGUI::UpdateSoundVolumeControls() {
	...
	m_SoundVolumeLabel->SetText("音效音量: " + std::to_string(soundVolume)); //Volume
